      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Notre meubles Chilift est à la fois élégant et apaisant,
              contribuant à améliorer votre bien-être mental et physique.
            </p>
        ...
        <div className="border-gray-200 mt-12 border-t pt-8">
          <p className="text-gray-400 text-base xl:text-center">
            &copy; 2023 Chilift, Inc. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
